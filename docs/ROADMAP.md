...
| #33–#35, #40–#49, #51, #52, #54–#58 | **Not started.** The property and differential harnesses, `--compat-java`, the service facade, the API/MCP/A2A/UI surface, the rest of the distributed work, and the release machinery. |
