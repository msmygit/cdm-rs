...
| `TST-060` | **Benchmarks**: `criterion` micro-benchmarks for the hot path (bind, convert, compare) and a reproducible macro-benchmark… | `crates/*/benches`, `cdm-testkit::macrobench`, `xtask` (`cargo xtask bench`) | `tst_060_*` | #55 |
